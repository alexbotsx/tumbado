/**
𝐆𝐇𝐎𝐒𝐓 𝐁𝐎𝐓@BrunoSobrino - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '595984303784-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐆𝐇𝐎𝐒𝐓 𝐁𝐎𝐓', 'jpegThumbnail': null } } };
