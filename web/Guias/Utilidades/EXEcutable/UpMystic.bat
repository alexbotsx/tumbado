...
IF NOT EXIST "%USERPROFILE%\mystic" (
    ...
    git clone https://chat.whatsapp.com/In9Sjk9rGnUAE0oLnigkGB.git "%USERPROFILE%\mystic"
...
git pull https://chat.whatsapp.com/In9Sjk9rGnUAE0oLnigkGB.git > git_output.txt
